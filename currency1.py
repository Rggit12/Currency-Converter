...
class CurrencyConverterUI(tk.Tk):
    def __init__(self, converter):
        ...
        self.intro_label = Label(self, text='Welcome to Real Time Currency Convertor', fg="blue", relief=tk.RAISED,
                                 borderwidth=3, font="san-sarif 3 italic")
        ...
        # Entry box
        valid = (self.register(self.restrictnumberonly), '%d')
        # restricNumberOnly function will restrict the user to enter invalid number in Amount field.
